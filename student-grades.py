...
def calculate_total_average(students): 
    ...
    return (0.1 * assignment + 0.7 * test + 0.2 * lab) #weighted results
...
def class_average_is(student_list): #total avg for class
    result_list = [] 
...
for i in students : 
    print(i["name"],"| Average: ",calculate_total_average(i),"| Grade: ", assign_letter_grade(calculate_total_average(i)))
  
# Calculate the average of whole class 
class_av = class_average_is(students) 

print( "Class Average: ",(class_av),"Class Grade: ",(assign_letter_grade(class_av))) 

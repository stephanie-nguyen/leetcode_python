...
Write a function:
    def solution(S)
that, given a string S encoding a decimal integer N, returns a string representing the Hexspeak representiion H of N if H is a valid Hexspeak word, otherwise it should return "ERROR".

A decimal number can be converted into hexspeak by first converting it to a hexadecimal, then converting the number 0 to the letter "O" and the number 1 to the letter "I". A string is considered a valid hexspeak word if it consists of only the ABCDEFIO letters.

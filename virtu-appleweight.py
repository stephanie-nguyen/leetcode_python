...
\apple's weight, returns the maximum 
...
in the box followed by zero or more 
...
You should return 2, as the box already contains K=4650 grams of items, so only 2 more apples of weight 150 wiykd fit 
(bringing the total weight to 4950, still 
below the capacity).
